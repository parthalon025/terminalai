@echo off
REM DVD to 4K Upscale
REM Usage: upscale_dvd_4k.bat input.mp4 [output.mp4]
...
if "%INPUT%"=="" (
    ...
    echo.
    echo Upscales DVD-quality video to 4K using NVIDIA Maxine
